...
const GaugeSphere = ({
                         ...
                         offset = sphereGaugeOptions.offset,
                         arcStrokeWidth = sphereGaugeOptions.arcStrokeWidth,
                         strokeLineCap = sphereGaugeOptions.strokeLineCap,
                         tickLength = sphereGaugeOptions.tickLength,
                         baseRadius = sphereGaugeOptions.baseRadius,
